...
Gerado em 2026-09-01 por `99-Templates/gerar_indice_urls.py`. URLs únicas no vault: 109, sendo 106 fontes externas e 3 endpoints locais de exemplo (listados ao final, não são fontes). Escopo: `.md`, `.py` e `.txt`, excluindo este índice, os relatórios de validação e o lockfile. O índice é auxiliar; a nota de origem continua sendo a autoridade contextual.
...
| https://docs.langchain.com/ | 07-Implementacao-Casa/RAG-livro.md |
| https://docs.nvidia.com/cuda/ | 04-Software/Compatibilidade-por-stack.md, 04-Software/Cookbooks-multiplataforma.md |
| https://docs.nvidia.com/networking/display/ibta | 08-Implementacao-Empresa/03-Paralelismo-e-multi-GPU.md |
| https://docs.nvidia.com/nvidia-hpc-benchmarks/NVLink_Benchmarks.html | 08-Implementacao-Empresa/03-Paralelismo-e-multi-GPU.md |
...
| https://docs.trychroma.com/ | 07-Implementacao-Casa/03-RAG-deploy.md |
...
| https://github.com/ggerganov/llama.cpp | 03-Hardware/Catalogo-NVIDIA-IA-local.md |
...
| https://github.com/ml-explore/mlx | 03-Hardware/Mac-Studio-e-IA-local.md, 04-Software/Cookbooks-multiplataforma.md, 04-Software/Runtimes.md, 11-Referencias/Fontes-principais.md |
...
| https://github.com/ollama/ollama/blob/main/docs/api.md | 01-Fundamentos/Entrada-e-saida.md, 07-Implementacao-Casa/01-LLM-local-com-Ollama.md, 07-Implementacao-Casa/03-RAG-deploy.md |
...
| https://sbert.net/ | 07-Implementacao-Casa/03-RAG-deploy.md, 07-Implementacao-Casa/Embeddings-e-vector-search.md, 07-Implementacao-Casa/RAG-livro.md |
...
| https://www.apple.com/br/mac-studio/ | 03-Hardware/Comparativo-workstations-vs-GPU.md, 03-Hardware/Mac-Studio-e-IA-local.md |
| https://www.apple.com/br/shop/buy-mac/mac-studio | 03-Hardware/Mac-Studio-e-IA-local.md |
...
| URL | Arquivos de origem |
|---|---|
| http://127.0.0.1:11434 | 07-Implementacao-Casa/03-RAG-deploy.md, 07-Implementacao-Casa/RAG-local-executavel.py |
