...
- Markdown no pacote: 91
- Markdown analisados: 89 (excluídos os relatórios VALIDACAO-COMPLETA.md, VALIDACAO.md)
- Erros: 0
- Avisos: 3
...
## Avisos
- NO_REFERENCES_SECTION 00-Inicio/MAPA.md
- NO_REFERENCES_SECTION 03-Hardware/AMD-e-Apple-Silicon-para-IA-local.md
