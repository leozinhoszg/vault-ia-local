...
- Markdown no pacote: 113
- Markdown analisados: 111 (excluídos os relatórios VALIDACAO-COMPLETA.md, VALIDACAO.md)
- Arquivos na triagem textual heurística: 126 (.cfg, .ini, .json, .key, .md, .pem, .properties, .ps1, .py, .sh, .toml, .txt, .yaml, .yml; nomes especiais: .env*)
